...
nombre = ``「ALERTA」`  ${usuario} Ha cambiado el nombre del grupo.\n\n> 💋 Ahora el grupo se llama:\n> *${m.messageStubParameters[0]}*.`
foto = ``「ALERTA」`  Se ha cambiado la imagen del grupo.\n\n> 💋 Acción hecha por:\n> » ${usuario}`
edit = ``「ALERTA」`  ${usuario} Ha permitido que ${m.messageStubParameters[0] == 'on' ? 'solo admins' : 'todos'} puedan configurar el grupo.`
newlink = ``「ALERTA」`  El enlace del grupo ha sido restablecido.\n\n> 💋 Acción hecha por:\n> » ${usuario}`
status = ``「ALERTA」`  El grupo ha sido ${m.messageStubParameters[0] == 'on' ? '*cerrado*' : '*abierto*'} Por ${usuario}\n\n> 💋 Ahora ${m.messageStubParameters[0] == 'on' ? '*solo admins*' : '*todos*'} pueden enviar mensaje.`
admingp = ``「ALERTA」`  @${m.messageStubParameters[0].split`@`[0]} Ahora es admin del grupo.\n\n> 💋 Acción hecha por:\n> » ${usuario}`
noadmingp = ``「ALERTA」`  @${m.messageStubParameters[0].split`@`[0]} Deja de ser admin del grupo.\n\n> 💋 Acción hecha por:\n> » ${usuario}`
